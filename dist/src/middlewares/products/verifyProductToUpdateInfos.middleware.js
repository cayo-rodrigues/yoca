...
const verifyProductToUpdateInfosMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const nameUnavailable = yield productsRepo.findOne({
        where: {
            name,
    ...
    if (nameUnavailable) {
        throw new AppError_1.default("Product name already in use", 409);
    }
...
exports.default = verifyProductToUpdateInfosMiddleware;
